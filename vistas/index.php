...
<head>
    ...
    <title>Indice Mini Proyecto</title>
...
<body>
    ...
    <div class="contenedor-principal">
        ...
        <div class="tarjeta tarjeta-p3">
            ...
            <a href="problema3.php">Ir al problema 3</a>
        </div>
        ...
        <div class="tarjeta tarjeta-pr1">
            ...
            <a href="problema4.php">Ir al problema 4</a>
        </div>
        ...
        <div class="tarjeta tarjeta-pr2">
            ...
            <a href="problema5.php">Ir al problema 5</a>
        </div>
        ...
        <div class="tarjeta tarjeta-pr3">
            ...
            <a href="problema6.php">Ir al problema 6</a>
        </div>

        <div class="tarjeta tarjeta-a1">
            <h2>Problema 7</h2>
            <p><strong>Calculadora de Datos Estadísticos:</strong> Pedir la cantidad de notas que desea ingresar el usuario. Calcular promedio, desviación estándar, nota mínima y máxima usando <strong>foreach</strong>.</p>
            <a href="problema7.php">Ir al problema 7</a>
        </div>
        ...
        <div class="tarjeta tarjeta-a2">
            ...
            <a href="problema8.php">Ir al problema 8</a>
        </div>
        ...
        <div class="tarjeta tarjeta-a3">
            ...
            <a href="problema9.php">Ir al problema 9</a>
        </div>
