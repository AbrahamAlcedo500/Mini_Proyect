...
class Utilidades {
    ...
    /**
     * Valida el token del formulario contra el de la sesión
     */
    ...
    /**
     * Enlace de retorno limpio acoplado a hojas de estilos
     */
    public static function enlaceVolver() {
        return '<a href="index.php" class="btn-volver">← Volver al Menú Principal</a>';
    }
}